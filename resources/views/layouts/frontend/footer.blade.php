                        ...
                        <div class="subscribe-item">
                            <form class="newsletter-form">
                                <input type="email" class="form-control" placeholder="Enter your email"
                                    autocomplete="off">
                                <button class="btn cmn-btn" type="submit"><i
                                        class="fas fa-paper-plane me-2"></i>Subscribe Now</button>
                            </form>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="footer-widget footer-social">
                        ...
                        <div class="footer-social-info d-block">
                            <div class="footer-insta-info">
                                <div><img src="frontend/assets/img/course/1.jpg" alt="" class="img-fluid"></div>
                                <div><img src="frontend/assets/img/course/2.jpg" alt="" class="img-fluid"></div>
                                <div><img src="frontend/assets/img/course/3.jpg" alt="" class="img-fluid"></div>
                                <div><img src="frontend/assets/img/course/3.jpg" alt="" class="img-fluid"></div>
                                <div><img src="frontend/assets/img/course/6.jpg" alt="" class="img-fluid"></div>
                                <div><img src="frontend/assets/img/course/2.jpg" alt="" class="img-fluid"></div>
                                <div><img src="frontend/assets/img/course/4.jpg" alt="" class="img-fluid"></div>
                                <div><img src="frontend/assets/img/course/5.jpg" alt="" class="img-fluid"></div>
                                <div><img src="frontend/assets/img/course/6.jpg" alt="" class="img-fluid"></div>
                            </div>
                        </div>
                    </div>
